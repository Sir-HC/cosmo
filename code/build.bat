...
cl  %CommonCompilerFlags% %CoreFlags% ..\code\core.cpp -Fmcore.map /LD /link -incremental:no /PDB:core_%timestamp%.pdb -EXPORT:GameUpdateAndRender -EXPORT:GameGetSoundSamples
